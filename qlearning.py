...
class QLearningUpdata:
    def __init__(self, in_record_path, out_table_path, where_pool, where_category_path,
        ...
        while (not self.isstop):
            ...
            try:
                for info in range(self.care_number):
                    ...
                    where_score = list(map(int, where_score[1:-1].split(","))) ## transform string to int
            ...
            for i in range(len(whens)):
                main_states.append(whens[i] + "_" + wheres[i] + "_" + whats[i])
                ...
                if os.path.exists(self.out_table_path):
                    ...
                    for state in long_term_state:
                        ...
                        for old_state in old_main_states_rows:
                            qtable.loc[old_state, state] = old_qtable.loc[old_state, state]
