...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        audio_thread_cam1 = AudioRecorder(cam_ip='rtsp://uscclab:uscclab@192.168.65.11:554/stream1',
                                          audio_spath='temporarily_rtsp_data/for_speaking/cam1',
                                          audio_stime=5,
                                          pos_path='nlp_recognize/pos.json',
                                          dict_path='nlp_recognize/extra_dict.txt')
        video_thread_cam1 = VideoRecorder(cam_ip='rtsp://uscclab:uscclab@192.168.65.11:554/stream1', 
                                          record_path='record/',
                                          qtable_path='q_table/',
        ...
        audio_thread_cam2 = AudioRecorder(cam_ip='rtsp://uscclab:uscclab@192.168.65.11:554/stream1',
                                          audio_spath='temporarily_rtsp_data/for_speaking/cam2',
                                          audio_stime=5,
                                          pos_path='nlp_recognize/pos.json',
                                          dict_path='nlp_recognize/extra_dict.txt')
        video_thread_cam2 = VideoRecorder(cam_ip='rtsp://uscclab:uscclab@192.168.65.11:554/stream1', 
                                          record_path='record/',
                                          qtable_path='q_table/',
                                          compress_result=True,
                                          fps=15, 
